...
public class MultiFileWordCount extends Configured implements Tool {
    ...
    public static class CombineFileLineRecordReader
        ...
        private static final Log logger = LogFactory.getLog(CombineFileLineRecordReader.class);
        ...
        public CombineFileLineRecordReader(CombineFileSplit split,
            ...
            logger.error("this path " + this.path);
    ...
    /**
     * This Mapper is similar to the one in {@link FindFriends.TokenizerMapper}.
     */
