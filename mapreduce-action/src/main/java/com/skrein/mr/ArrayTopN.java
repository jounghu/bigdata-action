...
public class ArrayTopN {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(ArrayTopN.class);
        job.setMapperClass(ArrayTopN.TokenizerMapper.class);
        ...
        job.setCombinerClass(ArrayTopN.IntSumReducer.class);
        job.setReducerClass(ArrayTopN.IntSumReducer.class);
